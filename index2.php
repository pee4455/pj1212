			...
			<div class="row">
				...
				<div class="col-md-4  col-12">
					<div class="card ">
						<div class="card-content">
							<img src="img/kinga-howard-neAymtPgUHs-unsplash.jpg" alt="Card Image" class="card-img">
							<div class="card-overlay">
								<a href="http://localhost:7272/index.html">
								<button id="startButton" class="card-btn">Start Simulator</button>
								</a>
							</div>
							<h2 class="card-title">Card Title</h2>
							<p class="card-body">This is some text inside of a div block.</p>
						</div>
					</div>
				</div>
				...
				<div class="card ">
						<div class="card-content">
							<img src="img/kinga-howard-neAymtPgUHs-unsplash.jpg" alt="Card Image" class="card-img">
							<div class="card-overlay">
								<button class="card-btn">Start Simulator</button>
							</div>
							<h2 class="card-title">Card Title</h2>
							<p class="card-body">This is some text inside of a div block.</p>
						</div>
